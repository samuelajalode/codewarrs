...
/*function findEvenIndex(arr)
{
  ...
  for (let i = 0; i<arr.length; i++){
    ...
    //console.log(getSum());
    let startSum = getSum(arr.slice(0, i));
    let endSum = getSum(arr.slice(i + 1));
...
// accum + elem adds the sum of the array to the number

// 0 is the initial value of the sum

// i is the index of the array

// return i returns the index of the array

// return -1 returns -1 if the array is empty

// return accum += elem returns the sum of the array
